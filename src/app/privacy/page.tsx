...
export default function PrivacyPage() {
  return (
    <LegalPage eyebrow="MR. TAROT" title="개인정보처리방침" updatedAt="2026년 9월 9일">
      ...
      <LegalSection title="3. 익명 이용 집계">
        <p>Threads 링크로 방문한 경우 해당 게시물 번호 또는 프로필 링크 표식만 현재 브라우저 세션에 보관합니다. 방문, 리딩 시작, 결과 도달, 제휴 링크 선택 같은 단계별 횟수를 한국 시간 기준 일자별 합계로 집계하며 최대 120일 뒤 자동 삭제합니다.</p>
        <p>이 집계에는 질문 원문, 선택 카드, 이름, 이메일, IP 주소, User-Agent, 쿠키 식별자 또는 지속적인 이용자 식별 정보를 저장하지 않습니다.</p>
      </LegalSection>

      <LegalSection title="4. 제휴 링크">
